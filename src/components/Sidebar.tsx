        ...
        <>
            ...
            <aside className={`${styles.sidebarContainer} ${isOpen ? styles.sidebarOpen : ''}`}>
                ...
                <nav className={styles.nav}>
                    ...
                    <Link
                        href="/autonomous"
                        className={`${styles.navLink} ${pathname === '/autonomous' ? styles.activeLink : ''}`}
                    >
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M12 2v4" />
                        ...
                        <span>Autonomní trading</span>
                    </Link>
                    <Link
                        href="/investment"
                        className={`${styles.navLink} ${pathname === '/investment' ? styles.activeLink : ''}`}
                    >
                        <InvestmentIcon />
                        <span>Investice</span>
                    </Link>
                    ...
                    <Link
                        href="/"
                        className={`${styles.navLink} ${pathname.startsWith('/home') ? styles.activeLink : ''}`}
                    >
                        <HomeIcon />
                        <span>Home</span>
                    </Link>
